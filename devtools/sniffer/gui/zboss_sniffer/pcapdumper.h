...
class PcapDumper : public QObject
{
    Q_OBJECT
public:
    explicit PcapDumper(QObject *parent = 0);
    explicit PcapDumper(QIODevice *dumpDest, QObject *parent = 0);
...
private:
    ...
    void writePacketHeader(int len);
