...
echo "run ns-3"
../../devtools/network_simulator/network_simulator --nNode=2 --PipeName=${PIPE_NAME}  --XGML=2nodes.xgml &
PipePID=$!
...
./nwk_route_discovery_source  ${PIPE_NAME}1.write ${PIPE_NAME}1.read 0 &
srcPID=$!
