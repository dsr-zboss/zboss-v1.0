...
./tp_zdo_bv_01_zc ${PIPE_NAME}0.write ${PIPE_NAME}0.read &
coordPID=$!
wait_for_start zc
echo ZC STARTED OK

echo "run zed"
./tp_zdo_bv_01_zed ${PIPE_NAME}1.write ${PIPE_NAME}1.read &
endPID=$!
wait_for_start zed
echo ZED STARTED OK

echo "run router"
./tp_zdo_bv_01_zr ${PIPE_NAME}2.write ${PIPE_NAME}2.read &
rPID=$!
wait_for_start zr
echo ZR STARTED OK
