...
./TP_ZDO_BV_03_DUTZC ${PIPE_NAME}0.write ${PIPE_NAME}0.read &
coordPID=$!
wait_for_start zc
...
echo "run ze1"
./TP_ZDO_BV_03_ZED1 ${PIPE_NAME}1.write ${PIPE_NAME}1.read &
ed1PID=$!
wait_for_start zed1
...
echo "run ze2"
./TP_ZDO_BV_03_ZED2 ${PIPE_NAME}2.write ${PIPE_NAME}2.read &
ed2PID=$!
wait_for_start zed2
