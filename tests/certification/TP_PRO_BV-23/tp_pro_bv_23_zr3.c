...
/* For NS build first ieee ad/dr byte should be unique */
#ifdef ZB_NS_BUILD
zb_ieee_addr_t g_zr3_addr = {0x04, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00};
#else
...
#endif
  ZB_IEEE_ADDR_COPY(ZB_PIB_EXTENDED_ADDRESS(), &g_zr3_addr);
