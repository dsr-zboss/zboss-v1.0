...
void tst_set_panid()
{
  ...
  TRACE_MSG(TRACE_NWK1, "Set PANID", (FMT__0));


  /* start PAN */
  ZB_BUF_INITIAL_ALLOC(buf, sizeof(zb_mlme_start_req_t) + sizeof(zb_uint8_t), req);
  ...
  zb_mlme_start_request(ZB_REF_FROM_BUF(buf));
}
