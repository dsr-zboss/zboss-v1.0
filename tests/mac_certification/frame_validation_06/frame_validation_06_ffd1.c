...
*                                                                          *
****************************************************************************
PURPOSE: test for mac - TP/154/MAC/FRAME-VALIDATION-06, FFD1 (Tester)
...
#define ZB_TESTER_BAD_PAN_ID  0x1AA0


#define LOG_FILE          "mac_fv_06_ffd1"
...
//  data_req -> dst_pan_id          = ZB_DUT_PAN_ID;
  data_req -> dst_pan_id          = ZB_TESTER_BAD_PAN_ID;
