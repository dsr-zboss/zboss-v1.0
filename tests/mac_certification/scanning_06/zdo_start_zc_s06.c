...
#define ZB_TEST_COORD_NUMBER          1

#define ZB_TEST_ADDR                  ZB_TEST_COORD_NUMBER
#define TEST_PAN_ID                   ZB_TEST_COORD_NUMBER
...
zb_ieee_addr_t g_ieee_addr = { ZB_TEST_COORD_NUMBER, ZB_TEST_COORD_NUMBER, ZB_TEST_COORD_NUMBER, ZB_TEST_COORD_NUMBER,
                               ZB_TEST_COORD_NUMBER, ZB_TEST_COORD_NUMBER, ZB_TEST_COORD_NUMBER, ZB_TEST_COORD_NUMBER }; /* test extended addres */
...
MAIN()
{
  ...
  sprintf(log_name, "tst_zc%i_", ZB_TEST_COORD_NUMBER);
