...
./zdo_zc_channel_mgr_test ${PIPE_NAME}0.write ${PIPE_NAME}0.read &
coordPID=$!
wait_for_start zc
...
echo "run zr1"
./zdo_zr_channel_mgr_test ${PIPE_NAME}1.write ${PIPE_NAME}1.read &
router1PID=$!
wait_for_start zr
...
if grep "Test is finished" zdo_zr*.log
then
