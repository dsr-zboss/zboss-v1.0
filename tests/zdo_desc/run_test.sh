...
echo "run ns"
../../devtools/network_simulator/network_simulator --nNode=2 --pipeName=${PIPE_NAME}  1>ns.txt 2>&1 &
PipePID=$!
...
./zdo_zc_test_desc ${PIPE_NAME}0.write ${PIPE_NAME}0.read &
coordPID=$!
wait_for_start zc
...
echo "run zr"
./zdo_zr_test_desc ${PIPE_NAME}1.write ${PIPE_NAME}1.read &
router1PID=$!
wait_for_start zr
