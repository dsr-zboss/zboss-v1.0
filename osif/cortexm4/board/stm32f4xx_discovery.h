...
#ifndef __ZB_STM32F4XX_DISCOVERY_H
#define __ZB_STM32F4XX_DISCOVERY_H
...
/* MISO/SDO PB.14 */
#define ZB_SPIx_MISO_PIN                  GPIO_Pin_14
#define ZB_SPIx_MISO_GPIO_PORT            GPIOB
#define ZB_SPIx_MISO_GPIO_CLK             RCC_AHB1Periph_GPIOB
#define ZB_SPIx_MISO_SOURCE               GPIO_PinSource14
#define ZB_SPIx_MISO_AF                   GPIO_AF_SPI2

/* MOSI/SDI PB.15 */
#define ZB_SPIx_MOSI_PIN                  GPIO_Pin_15
#define ZB_SPIx_MOSI_GPIO_PORT            GPIOB
#define ZB_SPIx_MOSI_GPIO_CLK             RCC_AHB1Periph_GPIOB
#define ZB_SPIx_MOSI_SOURCE               GPIO_PinSource15
#define ZB_SPIx_MOSI_AF                   GPIO_AF_SPI2


/* NSS(SEL) PB.12 */
#define ZB_SPIx_NSS_PIN                   GPIO_Pin_12
#define ZB_SPIx_NSS_GPIO_PORT             GPIOB
#define ZB_SPIx_NSS_GPIO_CLK              RCC_AHB1Periph_GPIOB

/* RF Int */
#define ZB_SPIx_RFINT_PIN                GPIO_Pin_8
#define ZB_SPIx_RFINT_GPIO_PORT          GPIOD
#define ZB_SPIx_RFINT_GPIO_CLK           RCC_AHB1Periph_GPIOD
#define ZB_SPIx_RFINT_SOURCE             GPIO_PinSource8
#define ZB_SPIx_RFINT_PORTSOURCE         EXTI_PortSourceGPIOD

#define ZB_SPIx_RFINT_LINE               EXTI_Line8
#define ZB_SPIx_RFINT_IRQHANDLER         EXTI9_5_IRQHandler
#define ZB_SPIx_RFINT_IRQCHANNEL         EXTI9_5_IRQn

/* RF Reset_N PB.11 */
#define ZB_SPIx_RFRES_PIN                 GPIO_Pin_11
...
#endif /* __ZB_STM32F4XX_DISCOVERY_H */
